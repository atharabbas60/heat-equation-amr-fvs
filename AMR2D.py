    ...
    for S in range(new_mesh.nsimplices):
        ...
        if center[0] < xc:
            ...
            if center[1] < yc:
                ...
                new_u[S] = uNE
    return new_u
def task3(n=4,Tfinal=2.0,dt=0.2,tolerance=0.009,theta=0.2):
    print("=" * 90)
    ...
    while current_time < Tfinal:
        ...
        # ------------------------------------------------
            ...
            print("nx =",mesh.nx)
            print("ny =",mesh.ny)
            # current_time is NOT changed.
            # The same time step is solved again.
# ============================================================
# RUN TASK 
# ============================================================
if __name__ == "__main__":task3(n=4,Tfinal=2.0,dt=0.2,tolerance=0.009,theta=0.2)